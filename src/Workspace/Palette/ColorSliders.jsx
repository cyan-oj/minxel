    ...
    <>
      <div className="color-preview">
        <div
          ...
          style={{ backgroundColor: colorString(cacheColor) }}
        >
          {cacheColorText}
        </div>
        <div
          className="color-edit-swatch"
          style={{ backgroundColor: colorString(rgbColor) }}
        >
          {newColorText}
        </div>
      </div>
      <div className="toolbar-clear">
        <button
          className={rgbSliders ? "named-icon-active" : "named-icon"}
          onClick={() => setSliders(true)}
        >
          rgb
        </button>
        <button
          className={rgbSliders ? "named-icon" : "named-icon-active"}
        ...
        {rgbSliders ? (
          <div className="sliders" id="rgb-sliders">
            <input
              ...
              value={rgbColor[0]}
              style={{
                backgroundImage: `linear-gradient(to right, rgb(0, ${rgbColor[1]}, ${rgbColor[2]}), rgb(255, ${rgbColor[1]}, ${rgbColor[2]}))`,
              }}
            ...
            <input
              ...
              style={{
                backgroundImage: `linear-gradient(to right, rgb(${rgbColor[0]}, 0, ${rgbColor[2]}), rgb(${rgbColor[0]}, 255, ${rgbColor[2]}))`,
              }}
            />
            <input
              type="range"
              ...
              style={{
                backgroundImage: `linear-gradient(to right, rgb(${rgbColor[0]}, ${rgbColor[1]}, 0), rgb(${rgbColor[0]}, ${rgbColor[1]}, 255))`,
              }}
            />
          </div>
        ) : (
          <div className="sliders" id="hsl-sliders">
            ...
            <input
              ...
              style={{
                backgroundImage: `linear-gradient(to right, hsl(${hslColor[0]}, 0%, ${hslColor[2]}%), hsl(${hslColor[0]}, 100%, ${hslColor[2]}%))`,
              }}
            />
            <input
              type="range"
              ...
              style={{
                backgroundImage: `linear-gradient(to right, hsl(${hslColor[0]}, ${hslColor[1]}%, 0%), hsl(${hslColor[0]}, ${hslColor[1]}%, 50%), hsl(${hslColor[0]}, ${hslColor[1]}%, 100%))`,
              }}
            />
          </div>
        )}
